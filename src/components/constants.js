...
export const MISSILE_DURATION = 1000;
export const ROCKET_WIDTH = 58;
export const ROCKET_HEIGHT = 58;
export const MISSILE_HEIGHT = 20;

// launcher left offset
export const ROCKET_OFFSET_LEFT = window.innerWidth * 0.05 + ROCKET_WIDTH / 2;

// left / right constraints for launcher
export const MIN_LEFT = 0;
export const MAX_LEFT = window.innerWidth * 0.9 - ROCKET_WIDTH;
